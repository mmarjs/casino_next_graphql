    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box flex={1} pl={1.5} position="relative" mt={3} display="flex" flexDirection="column" className={classes.spinAndBonusBar}>
                    {bonuses.map((item,index)=>{
                        return (
                                <Box mb={1.5} key={`bonus-item-in-${index}`} flex={1} display="flex" flexDirection="column">
                                    <Typography className={classes.percentText} color="inherit" fontWeight={700} textAlign="left" variant="h3">+{item.max_percent}%</Typography>
                                    <Typography className={classes.uptoText} color="inherit" fontWeight={600} textAlign="left" variant="h6">Up to {item.upto}$</Typography>
                                </Box>
                        )
                    })}
                    <Box display="flex">
                ...
                {promoImage &&
                <Box flex={1.5} maxWidth="60%" alignItems="flex-end" justifyContent="flex-end" display="flex" position="absolute" right={0} bottom={-10}>
                    <motion.div
                        variants={image}
                    >
                        <Image
            ...
            <Box className={classes.info} display="none">
